...
export interface Organization {
  id: string;
  organization_code: string; // e.g. "SWZ-060926"
  company_name: string;
  owner_name: string;
  email: string;
  phone: string;
...
export interface ShoppingCenter {
  ...
  name: string;
  address: string;
  location: string; // e.g. "Ezulwini Valley", "Mbabane Central", "Manzini City"
  description: string;
  image: string;
...
export interface Shop {
  ...
  property_id: string;
  shopping_center_id: string;
  shop_number: string; // e.g. "G-14"
  floor: string; // "Ground Floor", "Level 1"
  size_sqm: number;
  rental_amount: number; // in Emalangeni (E)
  ...
  description: string;
  power_specs?: string; // "3-Phase Power, Backup Generator"
...
export interface Tenant {
  ...
  trade_type: string; // "Fashion Retail", "Dining", "Financial Services"
  move_in_date: string;
  user_id?: string;
}
...
export interface Ticket {
  id: string;
  ticket_number: string; // e.g. "GA-G14-060926-0001"
  organization_id: string;
  shopping_center_id: string;
  property_id: string;
  shop_id: string;
...
export interface Vendor {
  ...
  organization_id: string;
  company_name: string;
  service_category: string; // "HVAC / Air Conditioning", "Elevators / Escalators", "Fire Protection", "Commercial Plumbing"
  contact_person: string;
  phone: string;
  email: string;
